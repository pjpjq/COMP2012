...
public:
    ...
    // it should do nothing and return false when there is already an item
    ...
    // if the key is not found in the container, you should use the following code in
    // the derived class's implementation of this function:
    ...
    // for example,
    // if n is 0, you should return the pointer to the smallest item (i.e. first smallest item)
    // if n is 1, you should return the pointer to the second smallest item
    // if n is the same as count()-1, you should return the pointer to the biggest item
